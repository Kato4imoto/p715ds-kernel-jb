...
/* LGE_CHANGE_S, Add 10 fps for line noise, 2013-01-25 hyungtae.lee@lge.com */
#define CAPTURE_10FPS 1
static struct msm_camera_i2c_reg_conf imx111_comm2_part1_settings[] = {
#if defined (CAPTURE_15FPS)	
	{0x0340, 0x09},
	{0x0341, 0xE2},
#elif defined (CAPTURE_10FPS)	
	{0x0340, 0x0E},
	{0x0341, 0xD8},
#endif	
/* LGE_CHANGE_E, Add 10 fps for line noise, 2013-01-25 hyungtae.lee@lge.com */
	{0x034C, 0x0C},
	{0x034D, 0xD0},
	{0x034E, 0x09},
	{0x034F, 0xA0},
